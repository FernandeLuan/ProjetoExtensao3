import { APP_VERSION, PAGAMENTOS } from "./constants.js?v=11.2";
import { state, definirConfiguracoes, onStateChange } from "./state.js?v=11.2";
import { salvarConfiguracoes } from "./data/configuracoes-repository.js?v=11.2";
