import { APP_VERSION, PAGAMENTOS } from "./constants.js?v=9.2";
import { state, definirConfiguracoes, onStateChange } from "./state.js?v=9.2";
import { salvarConfiguracoes } from "./data/configuracoes-repository.js?v=9.2";
import { converterParaNumero, formatarMoeda, aplicarMascaraMoedaInput } from "./utils/money.js?v=9.2";
...
async function confirmarExclusaoServico() {
    ...
    try {
        ...
        await concluirAcaoBotao(btnConfirmarServico, "Serviço excluído ✓", 460);
    } catch (error) {
        console.error(error);
        ...
        editar.addEventListener("click", () => {
            ...
            salvar.addEventListener("click", async () => {
                ...
                try {
                    ...
                    await concluirAcaoBotao(salvar, "Atualizado ✓", 460);
                } catch (error) {
                    console.error(error);
...
async function adicionarServico() {
    ...
    try {
        ...
        await concluirAcaoBotao(btnSalvarNovoServico, "Serviço cadastrado ✓", 460);
