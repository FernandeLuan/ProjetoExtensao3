...
import { inicioDoDia, somarDias, chaveData, mesmoDia, formatarTituloData, dataDeInput } from "./utils/date.js?v=9.0";
import { setTexto } from "./utils/dom.js?v=9.0";
import { abrirCalendarioPopover } from "./services/calendario-popover.js?v=9.0";
import { obterResumoDoDia } from "./services/financeiro-service.js?v=9.0";
import { garantirAtendimentosPeriodo } from "./data/sync.js?v=9.0";
import { listarResumosProfissionalPorPeriodo } from "./data/resumos-repository.js?v=9.0";
