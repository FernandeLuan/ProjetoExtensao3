...
import { criarAcessoBarbeiro } from "./services/equipe-service.js?v=9.1";
import { obterServicos } from "./services/catalogo-service.js?v=9.1";
import { papelEhAdmin, usuarioEhAdmin } from "./permissoes.js?v=9.1";
