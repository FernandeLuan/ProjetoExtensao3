...
} from "./data/equipe-repository.js?v=9.0";
import { criarAcessoBarbeiro } from "./services/equipe-service.js?v=9.0";
import { obterServicos } from "./services/catalogo-service.js?v=9.0";
import { papelEhAdmin, usuarioEhAdmin } from "./permissoes.js?v=9.0";
