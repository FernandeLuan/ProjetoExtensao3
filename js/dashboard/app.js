...
import { initNavigation } from "./navigation.js?v=8.16";
import { initRegistrar } from "./registrar.js?v=8.16";
import { initConfiguracoes } from "./configuracoes.js?v=8.8";
import { initRetroativo } from "./retroativo.js?v=8.16";
import { initEquipe } from "./equipe.js?v=8.16";
import { initDespesas } from "./despesas.js?v=8.10";
import { initConta } from "./conta.js?v=8.16";
import { initRelatorios } from "./relatorios.js?v=8.16";
