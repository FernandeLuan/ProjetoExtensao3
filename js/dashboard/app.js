...
import { initNavigation } from "./navigation.js?v=8.20";
import { initRegistrar } from "./registrar.js?v=8.16";
import { initConfiguracoes } from "./configuracoes.js?v=8.20";
import { initRetroativo } from "./retroativo.js?v=8.18";
import { initEquipe } from "./equipe.js?v=8.18";
import { initDespesas } from "./despesas.js?v=8.10";
import { initConta } from "./conta.js?v=8.18";
import { initRelatorios } from "./relatorios.js?v=8.18";
import { mostrarErro } from "./services/feedback-service.js?v=7.4";
import { exigirTrocaSenhaPrimeiroAcesso } from "./primeiro-acesso.js?v=8.16";
