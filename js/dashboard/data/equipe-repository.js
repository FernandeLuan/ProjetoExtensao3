...
import { state, definirEquipe, definirMembroAtual } from "../state.js?v=8.28";
import { usuarioEhAdmin, papelEhAdmin } from "../permissoes.js?v=8.28";
