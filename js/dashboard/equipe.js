...
} from "./data/equipe-repository.js?v=8.28";
import { criarAcessoBarbeiro } from "./services/equipe-service.js?v=8.28";
import { obterServicos } from "./services/catalogo-service.js?v=8.28";
import { papelEhAdmin, usuarioEhAdmin } from "./permissoes.js?v=8.28";
