const CACHE_NAME = "sr-nk-v2.2.0-etapa8-v829";
const APP_SHELL = [
  "./",
  "./index.html",
  "./login.html",
  ...
  "./icons/icon-192.png",
  "./icons/icon-512.png",
  "./css/dashboard.css?v=8.29",
  "./css/login.css?v=8.29",
  "./css/style.css",
  "./js/firebase-init.js?v=8.29",
  "./js/login.js?v=8.29",
  "./js/mobile-interactions.js?v=8.29",
  "./js/dashboard/index.js?v=8.29"
];
