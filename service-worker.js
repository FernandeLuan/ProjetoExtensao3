const CACHE_NAME = "sr-nk-v3.6-ux-regressivo-v960";
...
const CORE_SHELL = [
  ...
  "./icons/icon-192.png?v=9.6",
  "./icons/icon-512.png?v=9.6",
  "./Fotos/Sr.NK.jpg",
  "./css/style.css",
  "./css/login.css?v=9.6",
  "./js/firebase-init.js?v=9.6",
  "./js/login.js?v=9.6",
  "./js/shared/auth-area-session.js?v=9.6",
  "./js/mobile-interactions.js?v=9.6"
];
